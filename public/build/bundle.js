...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	let t1;
    	let p;
    	let raw_value = /*post*/ ctx[1].content.rendered + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t2 = space();
    			add_location(h2, file, 20, 3, 376);
    			add_location(p, file, 21, 3, 410);
    			attr_dev(section, "class", "svelte-m9wdkp");
    			add_location(section, file, 19, 2, 363);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ wordpress_url, getData });
    	return [];
    }
